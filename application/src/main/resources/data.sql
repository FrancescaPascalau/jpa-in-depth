...
INSERT INTO `bill` (`bill_id`, `type`, `amount`) VALUES (11, 'ELECTRICITY', 600.0);
INSERT INTO `bill` (`bill_id`, `type`, `amount`) VALUES (22, 'WATER', 50.0);
INSERT INTO `bill` (`bill_id`, `type`, `amount`) VALUES (33, 'GAS', 320.0);
